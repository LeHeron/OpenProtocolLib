...
public:
    ...
    explicit	DMid0002(QMap<int, QByteArray> args, int spindle_id = 1);
    explicit	DMid0002(int revision, QMap<int, QByteArray> args, int spindle_id = 1);
    explicit    DMid0002(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id);
