...
DMid0033::DMid0033(QMap<int, QByteArray> args, int spindle_id) : DMid0033(-1, args, spindle_id)
{}

DMid0033::DMid0033(int revision, QMap<int, QByteArray> args, int spindle_id)
    : DMid0033(revision, args, spindle_id, 1)
{}

DMid0033::DMid0033(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id)
{
    data_fields = args;
