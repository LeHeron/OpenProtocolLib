...
public:
    ...
    explicit	DMid0033(QMap<int, QByteArray> args, int spindle_id = 1);
    explicit	DMid0033(int revision, QMap<int, QByteArray> args, int spindle_id = 1);
    explicit    DMid0033(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id);
