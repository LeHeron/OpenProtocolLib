...
DMid0035::DMid0035(QMap<int, QByteArray> args, int spindle_id) : DMid0035(-1, args, spindle_id)
{}

DMid0035::DMid0035(int revision, QMap<int, QByteArray> args, int spindle_id)
    : DMid0035(revision, args, spindle_id, 1)
{}

DMid0035::DMid0035(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id)
{
    data_fields = args;
