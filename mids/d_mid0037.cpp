...
DMid0037::DMid0037(QMap<int, QByteArray> args, int spindle_id) : DMid0037(-1, args, spindle_id)
{}

DMid0037::DMid0037(int revision, QMap<int, QByteArray> args, int spindle_id)
    : DMid0037(revision, args, spindle_id, 1)
{}

DMid0037::DMid0037(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id)
{
    data_fields = args;
