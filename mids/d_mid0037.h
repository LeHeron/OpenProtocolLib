...
public:
    ...
    explicit	DMid0037(QMap<int, QByteArray> args, int spindle_id = 1);
    explicit	DMid0037(int revision, QMap<int, QByteArray> args, int spindle_id = 1);
    explicit    DMid0037(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id);
