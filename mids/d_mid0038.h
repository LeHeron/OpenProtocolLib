...
public:
    ...
    explicit	DMid0038(QMap<int, QByteArray> args, int spindle_id = 1);
    explicit	DMid0038(int revison, QMap<int, QByteArray> args, int spindle_id = 1);
    explicit    DMid0038(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id);
