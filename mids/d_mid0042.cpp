...
void DMid0042::processData(QByteArray data_byte_array)
{

}

DMid0042::DMid0042(QByteArray arr)
    : DOpenProtocolMid(arr)
{
    DMid0042::processData(arr.mid(20, -1));
    REGISTER_RESPONSES();
}

DMid0042::DMid0042(QMap<int, QByteArray> args, int spindle_id) : DMid0042(-1, args, spindle_id)
{}

DMid0042::DMid0042(int revision, QMap<int, QByteArray> args, int spindle_id)
    : DMid0042(revision, args, spindle_id, 1)
{}

DMid0042::DMid0042(int revision, QMap<int, QByteArray> args, int spindle_id, int station_id)
{
    data_fields = args;
